...
const features = [
  {
    icon: (
      ...
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-12 h-12 text-pink-600 mx-auto mb-3">
...
const CallmindFeatures = () => (
  <section className="my-12">
    <h2 className="text-2xl md:text-3xl font-bold text-center mb-8 text-gray-800">CALLMIND ile Yapabilecekleriniz</h2>
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      {features.map((f, i) => (
        <div key={i} className="bg-white rounded-xl shadow p-6 flex flex-col items-center text-center h-full">
          {f.icon}
