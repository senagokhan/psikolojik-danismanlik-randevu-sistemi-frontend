...
const TherapistList = () => {
    ...
    return (
        <div>
            <h2 className="text-2xl font-bold mb-6 text-center">Terapistlerimiz</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {therapists.map(therapist => {
                  console.log('Therapist:', therapist);
                  const name = therapist.user?.fullName || therapist.fullName || '';
                  return (
                    <div key={therapist.id} className="bg-white rounded-lg shadow-lg p-6 text-center flex flex-col h-full">
                        ...
                        <Link 
                            ...
                            className="mt-auto bg-blue-500 text-white font-bold py-2 px-4 rounded hover:bg-blue-700 transition duration-300"
                        >
                            Randevu Al
                        </Link>
                    </div>
